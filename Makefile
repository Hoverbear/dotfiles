...
I3_DESKTOP_SRC=i3/desktop.png
I3_DESKTOP_DST=$(I3_CONFIG_FOLDER)/desktop.png

i3: $(I3_CONFIG_DST) $(I3_DESKTOP_DST) $(I3STATUS_CONFIG_DST)
# Install the i3 config.
$(I3_CONFIG_FOLDER): 
	mkdir -p $(I3_CONFIG_FOLDER)
$(I3_CONFIG_DST): $(I3_CONFIG_FOLDER)
	ln $(I3_CONFIG_SRC) $(I3_CONFIG_DST)
$(I3_DESKTOP_DST): $(I3_CONFIG_FOLDER) $(I3_DESKTOP_SRC)
	ln $(I3_DESKTOP_SRC) $(I3_DESKTOP_DST)
$(I3STATUS_CONFIG_FOLDER):
	mkdir -p $(I3STATUS_CONFIG_FOLDER)
$(I3STATUS_CONFIG_DST): $(I3STATUS_CONFIG_FOLDER)
...
I3LOCK_IMAGE_SRC=i3/lockscreen.png
I3LOCK_IMAGE_DST=$(I3_CONFIG_FOLDER)/lockscreen.png
i3lock: $(I3LOCK_DST) $(I3LOCK_IMAGE_DST)

$(I3LOCK_DST): .FORCE $(I3_CONFIG_FOLDER) 
	mkdir -p $(CONFIG_FOLDER)/systemd/user/
	ln $(I3LOCK_SRC) $(I3LOCK_DST)
	systemctl --user enable $(I3LOCK_SERVICE)
$(I3LOCK_IMAGE_DST): $(I3_CONFIG_FOLDER) $(I3LOCK_IMAGE_SRC)
	cp $(I3LOCK_IMAGE_SRC) $(I3LOCK_IMAGE_DST)
